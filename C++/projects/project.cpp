...
float amt;
void input() {
  cout << "Enter the consumer's name :" << endl;
  cin >> name;
  cout << "Enter the meter no :" << endl;
  cin >> meterno;
...
void displ() {
  cout << endl << "\t\t **UJJWALA POWER DISTRIBUTION(P) LTD. ** \t\t" << endl;
  cout << endl
       << "\tConsumer name                                     :" << name
       << endl;
  ...
  cout << "\tTotal units consumed                              :" << units
       << endl;
  cout << "\tCharge of total energy consumed                   :" << calc()
       << endl;
  cout << "\tFixed charge                                      :50" << endl;
  cout << "\tNet amount payable                                :" << amt + 50
       << endl;

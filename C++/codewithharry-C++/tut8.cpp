...
int main() {
  ...
  // constants in c++
  // first program
  // const int a =34; // if this const keyword is used then the value of a will
  // remain constant so that there are no
  //     const float b= 3.111// accidental mistakes. after the const value is
  //     initialised then after that the value cannot be changed cout<<"The
  //     value of a was :"<<a<<endl; a=45;// here it is trying to change but
  //     there will be error cout<<"The value of a is :"<<a<<endl;

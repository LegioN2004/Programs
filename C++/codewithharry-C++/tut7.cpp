...
int main() {
  ...
  // cout<<"The global variable is "<<::c; // :: this is scope resolution
  // operator, it is used to bring a global variable value in a local variable
  // one

  //*********** Float, double and long double literals ****************
  float d = 34.4f;  // here float value is written with f as compiler detects a
                    // decimal no as double if f is not used
  long double e = 34.4l;  // here l is written with the value to show that it is
                          // a long double data type
  ...
  // *************** Reference Variables *******************
  // float x = 455;
  // float & y=x; here '&' (ampersand) symbol is used to give a different name
  // to a variable for which the value of y is also the same as 455
  // cout<<x<<endl;
  // cout<<y<<endl;
  ...
  int c = int(b);  // this is valid , you can initialise the typecasted values
                   // to other values

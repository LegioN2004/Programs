...
// here we can use any data type and the compiler will try its best to convert
...
int main() {
  ...
  cout << "The volume of cylinder radius 3 and height 6 is " << volume(3, 6)
       << endl;
  cout << "The volume of cube of side  is " << volume(3) << endl;
  cout << "The volume of cuboid is  l=3,b=6,and h=7 is " << volume(3, 6, 7)
       << endl;

  return 0;
}

// in this way we can use the same name of function for different purposes with
// the help of function overloading

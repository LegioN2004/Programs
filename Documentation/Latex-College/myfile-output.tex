...
\begin{center}
	...
	%  \href{https://www.hackerrank.com/yourid}
	% {\raisebox{-0.2\height}\faHackerrank\ \underline{yourid}} ~
...
{\href{https://github.com/LegioN2004/BrokeTM}{\textbf{\large{\underline{BrokeTM - A payments app}}} \href{https://github.com/LegioN2004/BrokeTM}{\raisebox{-0.1\height}\faExternalLink }} $|$ \large{\underline{MERN with JWT auth}}}{MM YYYY}
\resumeItemListStart
\resumeItem{\normalsize{User authentication and authorization}}
\resumeItem{\normalsize{In-house transactions between users}}
\resumeItem{\normalsize{Responsive design using Tailwind CSS}}
...
\resumeProjectHeading
{\href{https://github.com/LegioN2004/netflix-clone}{\textbf{\large{\underline{netflix-clone}}} \href{Project Link}{\raisebox{-0.1\height}\faExternalLink }} $|$ \large{\underline{Technology Stack Used}}}{MM YYYY}
\resumeItemListStart
...
\resumeProjectHeading
{\href{https://github.com/LegioN2004/weather-app}{\textbf{\large{\underline{WeatherApp}}} \href{https://github.com/LegioN2004/weather-app}{\raisebox{-0.1\height}\faExternalLink }} $|$ \large{\underline{React-Native: cross-platform web technologies}}}{MM YYYY}
\resumeItemListStart
\resumeItem{\normalsize{It is a weather app made using cross-platform web technologies mainly \textbf{React-Native, React and JavaScript} }}
\resumeItem{\normalsize{It can run in both \textbf{iOS} and \textbf{Android}}}
\resumeItem{\normalsize{It shows the \textbf{weather forecast} in real time and is pretty accurate}}
\resumeItem{\textcolor{accent} {\href{https://github.com/LegioN2004/weather-app/releases} {\underline{\normalsize{Download apk}}}}}
\resumeItemListEnd
\resumeSubHeadingListEnd
\vspace{-12pt}

// README: extended the prism to the more detailed version (usage remains dependent on the user) by adding the types of prism and their individual calculations if not known by the user
...
public class VolumeOfPrism {
    public static void main(String[] args) {
        ...
        System.out.print("Wanna go to the more detailed version of the prism or the boring regular one then press yes/no: ");
        String yesORno = in.next().trim();
        if (yesORno.equals("yes".trim())) {
            System.out.print("Give the type of prism, from rectangle or triangular or regular: ");
            String key = in.next().trim();
            switch (key) {
                case "rectangle" -> {
                    System.out.print(
                            "You entered the type rectangle i.e rectangular prism, so give the area and height of the rectangular prism serially. If the area is not known then press no to calculate it explicitly, else press yes: ");
                    ...
                    if (area.equals("no")) {
                        ...
                        int ar = a3 * b3;
                        System.out.print(
                                "The area of the rectangle is found: " + ar + " so now give the value of prism height: ");
                        int c3 = in.nextInt();
                        int vol = ar * c3;
                ...
                case "triangle" -> {
                    ...
                    if (area1.equals("no")) {
                        ...
                        int ar = a3 * b3;
                        System.out.println(
                                "The area of the triangle is found: " + ar + " so now print the value of prism height: ");
                        int c3 = in.nextInt();
                        int vol = ar * c3;

...
public class primitives {
    public static void main(String[] args) {
        ...
        // string is not primitve , more on this in the note2.org
        String name = "Kunal"; // string value is always in double quotes
        char letter = 'K'; // char value is always in single quotes, can only add a letter
